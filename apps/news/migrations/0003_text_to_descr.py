...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'News.text' to 'News.description'
        db.rename_column('news_news', 'text', 'description')

    
    def backwards(self, orm):
        
        # Renaming field 'News.description' to 'News.text'
        db.rename_column('news_news', 'description', 'text')
    ...
    models = {
        ...
        'news.news': {
            'changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),

...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('registration_invitation', (
            ('id', orm['registration.Invitation:id']),
            ('email', orm['registration.Invitation:email']),
            ('created', orm['registration.Invitation:created']),
            ('submited', orm['registration.Invitation:submited']),
            ('sent', orm['registration.Invitation:sent']),
            ('user', orm['registration.Invitation:user']),
            ('comment', orm['registration.Invitation:comment']),
        ))
        db.send_create_signal('registration', ['Invitation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('registration_invitation')

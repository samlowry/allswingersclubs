...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('forum_group', 'category_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Group.category'
        raise RuntimeError("Cannot reverse this migration. 'Group.category' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Group.category'
        db.add_column('forum_group', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.GroupCategory']),
                      keep_default=False)

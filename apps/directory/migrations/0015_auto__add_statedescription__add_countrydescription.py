...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('directory_statedescription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.State'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
        ))
        db.send_create_signal('directory', ['StateDescription'])

        # Adding model 'CountryDescription'
        db.create_table('directory_countrydescription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.Country'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
        ))
        db.send_create_signal('directory', ['CountryDescription'])


    def backwards(self, orm):
        
        # Deleting model 'StateDescription'
        db.delete_table('directory_statedescription')

        # Deleting model 'CountryDescription'
        db.delete_table('directory_countrydescription')

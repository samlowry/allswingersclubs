...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Club.city'
        db.alter_column('directory_club', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.City']))


    def backwards(self, orm):
        
        # Changing field 'Club.city'
        db.alter_column('directory_club', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.City'], null=True, blank=True))
    ...
    models = {
        ...
        'directory.club': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['directory.City']"}),

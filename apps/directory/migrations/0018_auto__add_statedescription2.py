...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StateDescription2'
        db.create_table('directory_statedescription2', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.State'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
        ))
        db.send_create_signal('directory', ['StateDescription2'])


    def backwards(self, orm):
        # Deleting model 'StateDescription2'
        db.delete_table('directory_statedescription2')

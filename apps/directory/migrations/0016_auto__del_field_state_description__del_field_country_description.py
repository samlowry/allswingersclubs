...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('directory_state', 'description')

        # Deleting field 'Country.description'
        db.delete_column('directory_country', 'description')


    def backwards(self, orm):
        
        # Adding field 'State.description'
        db.add_column('directory_state', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Country.description'
        db.add_column('directory_country', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

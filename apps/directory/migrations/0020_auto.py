...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sites on 'Hookup'
        m2m_table_name = db.shorten_name('directory_hookup_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('hookup', models.ForeignKey(orm['directory.hookup'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['hookup_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field sites on 'Hookup'
        db.delete_table(db.shorten_name('directory_hookup_sites'))

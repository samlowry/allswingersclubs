...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        query = """CREATE FULLTEXT INDEX clubs_fulltext_index ON directory_club (name, description, address, phone,
                    email, homepage);"""        
    ...
    def backwards(self, orm):
        query = """ALTER TABLE directory_club DROP INDEX clubs_fulltext_index;"""
        cursor = connection.cursor()
        cursor.execute(query)
        connection.close()

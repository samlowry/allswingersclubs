...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('directory_country', 'region', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['directory.Region']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Country.region'
        db.delete_column('directory_country', 'region_id')
    ...
    models = {
        ...
        'directory.country': {
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['directory.Region']"})
        },
        'directory.photo': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Photo2'
        db.create_table('directory_photo2', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('hookup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.Hookup'])),
        ))
        db.send_create_signal('directory', ['Photo2'])

        # Adding model 'Hookup'
        db.create_table('directory_hookup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='hookups', null=True, to=orm['directory.State'])),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='hookups', null=True, to=orm['directory.City'])),
            ('date_of_publish', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ...
            ('body_art', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('diet', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('dislikes', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('drinks', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('drugs', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('education', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ethnicity', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('eye_color', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('facial_hair', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('fears', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('hair', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('hiv_hsv_hpv', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('interests', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('kids_have', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('kids_want', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('likes', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('native_language', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('occupation', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('personality', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('pets', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('politics', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('religion', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('resembles', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('smokes', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('zodiac', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('directory', ['Hookup'])


    def backwards(self, orm):
        # Deleting model 'Photo2'
        db.delete_table('directory_photo2')

        # Deleting model 'Hookup'
        db.delete_table('directory_hookup')

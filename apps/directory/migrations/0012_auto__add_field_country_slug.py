...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('directory_country', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Country.slug'
        db.delete_column('directory_country', 'slug')

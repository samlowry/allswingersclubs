...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hookup.datetime_of_publish'
        db.add_column('directory_hookup', 'datetime_of_publish',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 7, 8, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hookup.datetime_of_publish'
        db.delete_column('directory_hookup', 'datetime_of_publish')
    ...
    models = {
        ...
        'directory.hookup': {
            ...
            'datetime_of_publish': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 8, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),

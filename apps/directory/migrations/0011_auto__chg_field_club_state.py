...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Club.state'
        db.alter_column('directory_club', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.State'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Club.state'
        db.alter_column('directory_club', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.State']))
